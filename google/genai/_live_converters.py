...
def _LiveClientSetup_to_vertex(
  ...
  if getv(from_object, ['input_audio_transcription']) is not None:
    setv(
        to_object,
        ['inputAudioTranscription'],
        _AudioTranscriptionConfig_to_vertex(getv(from_object, ['input_audio_transcription']), to_object),
    )
  ...
  if getv(from_object, ['output_audio_transcription']) is not None:
    setv(
        to_object,
        ['outputAudioTranscription'],
        _AudioTranscriptionConfig_to_vertex(getv(from_object, ['output_audio_transcription']), to_object),
    )
